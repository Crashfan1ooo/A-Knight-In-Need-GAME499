...
public abstract class FlockingBehavior : ScriptableObject
{
    ...
    // an abstract method that includes the behaviors for what we want, This returns a Vector 3 called Calculate move that contains information from other scripts used for the flocking mechanism
